# MiniProject ONE (MEMORY)

<script>
$("#coverpic").hide();
</script>

In the first mini-project, you will read, summarize and discuss the paper by @nairne_adaptive_2008. Then, you will attempt to replicate their results in the lab, by conducting an experiment and analyzing the data.
...
3.  Students attempt to replicate the major findings in the paper
    ...
    b. Each group picks their own 30 words. Can follow same procedure as in paper by choosing 30 words from @van_overschelde_category_2004.
...
## Data-analysis tips {#lab-4-data-analysis-tips}
...
You can also look at the examples of conducting [one-factor ANOVAs in software using the lab manual from PSYC 3400 Introductory Statistics](https://crumplab.github.io/statisticsLab/lab-8-one-way-anova.html), and refresh your understanding of the ANOVA by [reading the ANOVA chapter from the PSYC 3400 textbook](https://crumplab.github.io/statistics/anova.html).
